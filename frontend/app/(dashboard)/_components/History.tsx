...
import { Currency, Period, Timeframe } from "@/lib/types";
import { useCallback, useMemo, useState } from "react";
import HistoryPeriodSelector from "./HistoryPeriodSelector";
import { useQuery } from "@tanstack/react-query";
import { getHistoryData } from "@/data/services/stats-service";
import {
    Bar,
    BarChart,
    CartesianGrid,
...
function History({ userCurrency }: { userCurrency: Currency }) {
