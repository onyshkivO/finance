...
import {ThemeSwitchBtn} from "@/components/custom/ThemeSwitchBtn";
        ...
        <div className="hidden border-separate border-b bg-background md:block">
            <nav className="flex items-center justify-between px-8">
                ...
                <div className="flex items-center gap-2 ml-auto">
                    {/* Aligning these items to the right */}
                    <ThemeSwitchBtn/>
                    <UserIcon/>
                </div>
            </nav>
    ...
    return (
        <div className="relative flex items-center">
            ...
            </Link>
            {
                isActive && (
                    <div
                        className="absolute -bottom-[2px] left-1/2 hidden h-[2px] w-[80%] -translate-x-1/2 rounded-x1 bg-foreground md:block"/>
                )
            }
        </div>
    )
